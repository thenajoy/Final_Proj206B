clear
folder = '/home/kotaru/Workspace/catkin_ws/qrotor_ws/bags/AUG31/';
file = 'twoDrones4ftHover.bag';

filename = strcat(folder,file);
bag = rosbag(filename);

points = DebagQrotor.readPoseArray(bag, '/mocap/unlabeled_points');
% markers_struct = readMessages(bagselect,'DataFormat','struct');
