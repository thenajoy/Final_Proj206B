...
% sys.controller = EulerPD();
% sys.controller = RateController();
% sys.controller = TiltPrioritizedController();
% sys.controller = NaiveGeometricControl();
% sys.controller = SO3GeometricCLFQP();
% sys.controller = SO3VariationLQR();
