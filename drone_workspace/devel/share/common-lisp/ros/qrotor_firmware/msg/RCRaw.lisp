...
(cl:defmethod cl:initialize-instance :after ((m <RCRaw>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RCRaw)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qrotor_firmware-msg:<RCRaw> is deprecated: use qrotor_firmware-msg:RCRaw instead.")))
...
(cl:defmethod values-val ((m <RCRaw>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qrotor_firmware-msg:values-val is deprecated.  Use qrotor_firmware-msg:values instead.")
  (values m))
